...
#ifndef _LEAFEDIT_PATTERN_EDITOR_PATTERN_HHD_HPP
#define _LEAFEDIT_PATTERN_EDITOR_PATTERN_HHD_HPP
...
class PatternHHD : public Pattern {
protected:
	u32 Offset;
	u8 *data;
public:
	virtual ~PatternHHD() {}
	PatternHHD(u8 *patternData, u32 offset) : Pattern(patternData, offset), Offset(offset), data(patternData) { }
