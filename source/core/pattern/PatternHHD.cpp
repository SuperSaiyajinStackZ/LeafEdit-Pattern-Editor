...
void PatternHHD::name(std::u16string v) {
...
void PatternHHD::creatorid(u16 v) {
...
void PatternHHD::creatorname(std::u16string v) {
...
void PatternHHD::creatorGender(u8 v) {
...
void PatternHHD::origtownid(u16 v) {
...
void PatternHHD::origtownname(std::u16string v) {
...
void PatternHHD::designtype(u8 v) {
...
void PatternHHD::injectData(u8 *buffer, u32 size) {
