...
SOURCES		:=	$(UNIVCORE) source source/common source/core source/core/pattern source/overlays source/screens source/ui
DATA		:=	data
INCLUDES	:=	$(UNIVCORE) include include/common include/core include/core/pattern include/overlays include/screens include/ui
GRAPHICS	:=	assets/gfx
ROMFS		:=	romfs
GFXBUILD	:=	$(ROMFS)/gfx
